        ...
        public async Task<IActionResult> Post(UserInfo _userData)
        {
            ...
            if (_userData != null && _userData.Email != null && _userData.Password != null)
            {
                ...
                if (user != null)
                {
                    ...
                    var token = new JwtSecurityToken(_configuration["Jwt:Issuer"], _configuration["Jwt:Audience"], claims, expires: DateTime.UtcNow.AddDays(10), signingCredentials: signIn);
